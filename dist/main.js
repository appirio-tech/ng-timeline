...
(function() {
  ...
  TimelineController = function($scope, $stateParams, $document, TimelineAPIService, CopilotApprovalAPIService) {
    ...
    vm.acceptQuote = function(event) {
      ...
      if ((ref = vm.copilot) != null ? ref.userId : void 0) {
        params = {
