...
$templateCache.put("views/image-slideshow-modal.directive.html","<modal show=\"vm.showModal\"><image-viewer-header avatar=\"{{vm.avatar}}\" handle=\"{{vm.handle}}\" title=\"{{vm.title}}\" download-allowed=\"download-allowed\"></image-viewer-header><image-slide-viewer files=\"vm.files\" starting-file=\"vm.startingFile\" show-notifications=\"vm.showNotifications\"></image-slide-viewer></modal>");}]);
(function() {
  'use strict';
  var directive;
