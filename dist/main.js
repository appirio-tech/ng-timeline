...
(function() {
  ...
  TimelineController = function($scope, $stateParams, TimelineAPIService, CopilotApprovalAPIService) {
    var activate, configureProjectSubmittedComponents, findCompletionDate, setExpanded, setIndexes, vm;
    vm = this;
    vm.eventGroups = [];
    vm.loading = true;
